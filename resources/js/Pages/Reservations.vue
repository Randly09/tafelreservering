        ...
        <div class="flex flex-col items-center justify-center pt-20 pb-20">
            ...
            <div class="mb-8">
                ...
                <img
                    src="/images/logo.png"
                    alt="Restaurant Logo"
                    class="w-70 h-40 mx-auto"
                />
            </div>
            <div>
                <Link
                    href="/reserved-tables"
            ...
            <!-- Main Card Container -->
            <div
                class="w-full max-w-2xl bg-blue-900/80 rounded-xl shadow-xl px-8 py-10 mx-4"
            >
                ...
                <div v-else-if="!loading" class="text-gray-100">
                    Search a date to find available tables.
                </div>
            </div>
        </div>
    </div>
